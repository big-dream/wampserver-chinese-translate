...
$langues = array(
    ...
    'However' => 'You may add another VirtualHost by validate "Add a VirtualHost".<br>However, for these new VirtualHost are taken into account by Wampmanager (Apache), you must run item<br><code>重启 DNS</code><br>from Right-Click Tools menu of Wampmanager icon.</i>',
    'HoweverWamp' => '虚拟主机添加成功，你可以点击“添加虚拟主机”继续添加新的虚拟主机。另外 Wampmanager 暂时不会显示该虚拟主机，你可以右键单击 Wampmanager 图标，然后选择<code>刷新</code></i>',
    'suppForm' => '删除虚拟主机',
    'suppVhost' => '删除虚拟主机',
